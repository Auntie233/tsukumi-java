...
import top.auntie.constant.Constant;
...
public class AuthUtils {
    ...
    private static String extractHeaderToken(HttpServletRequest request) {
        Enumeration<String> headers = request.getHeaders(Constant.TOKEN_HEADER);
    ...
    public static String[] extractClient(HttpServletRequest request) {
        ...
        if (header == null || !header.startsWith(BASIC_)) {
            log.error("请求头中client信息为空: url {}  header {} Authorization {}",
                    request.getRequestURL().toString(), request.getHeaderNames().toString(), header);
